...
Version  : 16.1.0
Release  : 56
URL      : http://tarballs.openstack.org/cinder/cinder-16.1.0.tar.gz
Source0  : http://tarballs.openstack.org/cinder/cinder-16.1.0.tar.gz
Source1  : cinder.tmpfiles
Source2  : http://tarballs.openstack.org/cinder/cinder-16.1.0.tar.gz.asc
...
%prep
%setup -q -n cinder-16.1.0
cd %{_builddir}/cinder-16.1.0
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594661915
...
cp %{_builddir}/cinder-16.1.0/LICENSE %{buildroot}/usr/share/package-licenses/cinder/294b43b2cec9919063be1a3b49e8722648424779
cp %{_builddir}/cinder-16.1.0/contrib/block-box/LICENSE %{buildroot}/usr/share/package-licenses/cinder/92170cdc034b2ff819323ff670d3b7266c8bffcd
